...
1. Open `tutorials/katacoda/getting-started/src/tekton-katacoda/tasks/buildTemplate.yaml`.
...
`tutorials/katacoda/getting-started/tekton/tasks/build.yaml`.
To apply this task, run the command below:

`cd ~/tutorials/katacoda/getting-started/src/tekton-katacoda/ && kubectl apply -f tasks/build.yaml`{{execute}}
...
1. Open `tutorials/katacoda/getting-started/src/tekton-katacoda/tasks/deployTemplate.yaml`.
2. Add the steps:
